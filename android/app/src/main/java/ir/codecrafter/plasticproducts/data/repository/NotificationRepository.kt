...
import ir.codecrafter.plasticproducts.data.network.NotificationApi
...
class NotificationRepository @Inject constructor(
    ...
    suspend fun getNotifications(): AuthResult<List<Notification>> =
        safeCall { notificationApi.getNotifications() }

    suspend fun markRead(id: Int): AuthResult<MarkReadResponse> =
        safeCall { notificationApi.markRead(id) }

    suspend fun markAllRead(): AuthResult<MarkReadResponse> =
        safeCall { notificationApi.markAllRead() }
